...
(function ($) {
    ...
    $.fn.fileinputLocales['fa'] = {
        fileSingle: 'تصویر',
        filePlural: 'تصاویر',
        browseLabel: 'افزودن تصویر',
        removeLabel: 'حذف',
        removeTitle: 'پاکسازی تصاویر انتخاب شده',
        cancelLabel: 'لغو',
        cancelTitle: 'لغو بارگزاری جاری',
        uploadLabel: 'آپلود',
        uploadTitle: 'آپلود تصاویر انتخاب شده',
        msgNo: 'نه',
        msgNoFilesSelected: 'هیچ تصویری انتخاب نشده است',
        msgCancelled: 'لغو شد',
        msgPlaceholder: 'انتخاب {files}...',
        msgZoomModalHeading: 'نمایش با جزییات',
        msgFileRequired: 'تصویری برای آپلود انتخاب کنید',
        msgSizeTooSmall: 'تصویر "{name}" (<b>{size} کیلوبایت</b>) خیلی کوچک است و باید از <b>{minSize} کیلوبایت بزرگتر باشد</b>.',
        msgSizeTooLarge: 'تصویر "{name}" (<b>{size} کیلوبایت</b>) از حداکثر مجاز <b>{maxSize} کیلوبایت</b> بزرگتر است.',
        msgFilesTooLess: 'شما باید حداقل <b>{n}</b> {files} تصویر برای آپلود انتخاب کنید.',
        msgFilesTooMany: 'تعداد تصاویر انتخاب شده برای آپلود <b>({n})</b> از حداکثر مجاز عبور کرده است <b>{m}</b>.',
        msgFileNotFound: 'تصویر "{name}" یافت نشد!',
        msgFileSecured: 'محدودیت های امنیتی مانع خواندن تصویر "{name}" است.',
        msgFileNotReadable: 'تصویر "{name}" قابل نوشتن نیست.',
        msgFilePreviewAborted: 'پیش نمایش تصویر "{name}". به مشکل خورد',
        msgFilePreviewError: 'در هنگام خواندن تصویر "{name}" خطایی رخ داد.',
        msgInvalidFileName: 'کاراکترهای غیرمجاز و یا ناشناخته در نام تصویر "{name}".',
        msgInvalidFileType: 'نوع تصویر "{name}" معتبر نیست. فقط "{types}" پشیبانی می‌شوند.',
        msgInvalidFileExtension: 'پسوند تصویر "{name}" معتبر نیست. فقط "{extensions}" پشتیبانی می‌شوند.',
        msgFileTypes: {
            'image': 'عکس',
            'html': 'اچ تا ام ال',
            'text': 'متن',
        ...
        msgUploadAborted: 'آپلود تصویر به مشکل خورد.',
        msgUploadThreshold: 'در حال پردازش...',
        msgUploadBegin: 'در حال شروع...',
        msgUploadEnd: 'انجام شد',
        msgUploadEmpty: 'هیچ داده معتبری برای آپلود موجود نیست.',
        msgUploadError: 'خطا',
        msgValidationError: 'خطای اعتبار سنجی',
        msgLoading: 'بارگیری تصویر {index} از {files} &hellip;',
        msgProgress: 'بارگیری تصویر {index} از {files} - {name} - {percent}% تمام شد.',
        msgSelected: '{n} {files} انتخاب شده',
        msgFoldersNotAllowed: 'فقط تصاویر را بکشید و رها کنید! {n} پوشه نادیده گرفته شد.',
        msgImageWidthSmall: 'عرض تصویر "{name}" باید حداقل {size} پیکسل باشد.',
        msgImageHeightSmall: 'ارتفاع تصویر "{name}" باید حداقل {size} پیکسل باشد.',
        msgImageWidthLarge: 'عرض تصویر "{name}" نمیتواند از {size} پیکسل بیشتر باشد.',
        msgImageHeightLarge: 'ارتفاع تصویر "{name}" نمی‌تواند از {size} پیکسل بیشتر باشد.',
        ...
        ajaxOperations: {
            deleteThumb: 'حذف تصویر',
            uploadThumb: 'آپلود تصویر',
            uploadBatch: 'آپلود جمعی تصاویر',
            uploadExtra: 'آپلود با کمک فُرم'
        },
        dropZoneTitle: 'تصاویر را بکشید و در اینجا رها کنید &hellip;',
        dropZoneClickTitle: '<br>(یا برای انتخاب {files} کلیک کنید)',
        fileActionSettings: {
            removeTitle: 'حذف تصویر',
            uploadTitle: 'آپلود تصویر',
            uploadRetryTitle: 'آپلود مجدد',
            downloadTitle: 'دانلود تصویر',
            zoomTitle: 'دیدن جزئیات',
            dragTitle: 'جابجایی / چیدمان',
            indicatorNewTitle: 'آپلود نشده است',
            indicatorSuccessTitle: 'آپلود شده',
            indicatorErrorTitle: 'خطا',
            indicatorLoadingTitle: 'آپلود ...'
        },
        previewZoomButtonTitles: {
            prev: 'مشاهده تصویر قبلی',
            next: 'مشاهده تصویر بعدی',
